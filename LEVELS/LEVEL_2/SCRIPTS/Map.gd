...
@onready var room_scene = [preload("res://LEVELS/LEVEL_2/SCENES/ROOMS/2_room_checkboard_1.tscn"), preload("res://LEVELS/LEVEL_2/SCENES/ROOMS/2_room_fungus_2.tscn"), preload("res://LEVELS/LEVEL_2/SCENES/ROOMS/2_room_Short_1.tscn"), preload("res://LEVELS/LEVEL_2/SCENES/ROOMS/2_room_spikes_1.tscn"), preload("res://LEVELS/LEVEL_2/SCENES/ROOMS/2_room_square_1.tscn"), preload("res://LEVELS/LEVEL_2/SCENES/ROOMS/2_room_square_2.tscn")]
